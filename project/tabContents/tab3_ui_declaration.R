tab3 <- function() {
  return(
    tabPanel('3. Journey Distance',
             ...
             wellPanel(
               h2('Instructions'),
               p("This tab allows the user to interactively analyze data about the average distance of bicikelj
               travels"),
               shiny::tags$li('In the first step the user can filter the data based on good weather (no rain and more
                than 5.3C temperature)
